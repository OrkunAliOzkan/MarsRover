...
int total_y = 0; //initialises actual total y-displacement from starting/reset position 


int total_x_optical1 = 0; //total x displacement before applying scale factor
int total_y1 = 0; //total y displacement before applying scale factor
...
total_x_optical_1 = total_x_optical_1 + distance_x_optica_l;
